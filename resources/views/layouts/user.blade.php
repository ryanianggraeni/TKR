      ...
      <div class="container navigation">
        ...
        <div class="navbar-header page-scroll">
          ...
          <a class="navbar-brand" href="index.html">
                    <img src="{{asset('img/'.$komponen->logo)}}" alt="" width="150" height="40" />
                </a>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                <img src="{{asset('img/'.$komponen->logo)}}" class="img-responsive" alt="" />
              </div>
            </div>
          </div>
        </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5a8bd5bb4b401e45400d0ef4/default';
s1.charset='UTF-8';
