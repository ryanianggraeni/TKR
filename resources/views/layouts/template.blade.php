...
<link href="{{asset('kiraric/layout/styles/layout.css')}}" rel="stylesheet" type="text/css" media="all">
</head>
<body id="top">
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
...
<!-- JAVASCRIPTS -->
<script src="{{asset('kiraric/layout/scripts/jquery.min.js')}}"></script>
<script src="{{asset('kiraric/layout/scripts/jquery.backtotop.js')}}"></script>
<script src="{{asset('kiraric/layout/scripts/jquery.mobilemenu.js')}}"></script>
</body>
</html>