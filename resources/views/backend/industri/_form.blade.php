                           ...
                           <div class="form-group{{ $errors->has('nama') ? 'has-error' : '' }}">
                            ...
                            <div>
                                {!! Form::label('testimonni','Testimoni *',['class'=>'col-md-9 col-md-offset-2']) !!}
                            ...
                            <div class="form-group{{ $errors->has('foto') ? 'has-error' : '' }}">
                            	{!! Form::label('foto','Foto Industri *',['class'=>'col-md-4 col-md-offset-2']) !!}
                                <div class="col-md-4">
                                @if(isset($industri) && $industri->foto)
                                <p>
                                    {!! Html::image(asset('image/'.$industri->foto),null,['class'=>'img-rounded img-responsive']) !!}
                                </p>
                                @endif
                            ...
                            <div class="form-group" align="center">
                                ...
                                <br>
                                <center>
                                {!! Form::submit('Simpan Industri', ['class'=>'btn btn-primary pull-right']) !!}
                                </center>
                                </div>
                            </div>
